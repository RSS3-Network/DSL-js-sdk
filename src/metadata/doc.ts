...
export const metadataDoc = {
  ...
  'transaction-multisig': {
    ...
    tag: 'transaction',
    type: 'multisig',
    actions: ['create', 'add_owner', 'remove_owner', 'change_threshold', 'execution'],
    examples: [
      {
        actionType: 'create',
  ...
  'collectible-auction': {
    ...
    platforms: ['Foundation', 'Zora', 'Nouns'],
    examples: [
      {
        actionType: 'create',
  ...
  'exchange-liquidity': {
    ...
    tag: 'exchange',
    type: 'liquidity',
    actions: ['add', 'remove', 'collect', 'supply', 'borrow', 'repay', 'withdraw'],
